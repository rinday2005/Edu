...
public class ManageArtical extends HttpServlet {
    ...
    private void listartical(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            System.out.println("=== DEBUG Article List ===");
            System.out.println("Current userID: " + userID);
            System.out.println("Total articles in DB: " + allArticles.size());
            
            // Tạm thời: Hiển thị TẤT CẢ bài viết để debug (sẽ filter lại sau)
            ...
            for (Article article : allArticles) {
                ...
                System.out.println("  Article userID: " + article.getUserID());
                System.out.println("  Current userID: " + userID);
                
                if (article.getUserID() != null) {
                    boolean matches = article.getUserID().equals(userID);
                    System.out.println("  Matches: " + matches);
                    
                    // TẠM THỜI: Thêm tất cả bài viết để kiểm tra
                    // TODO: Sau khi debug xong, chỉ thêm bài viết matches
                    articallist.add(article);
                    System.out.println("  -> ADDED to list (temporary - showing all)");
                } else {
                    System.out.println("  -> userID is NULL");
                }
            }
            
            System.out.println("Total articles to display: " + articallist.size());
